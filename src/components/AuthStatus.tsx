...
import { User, LogOut, Settings, ChevronDown, LayoutDashboard, Wallet } from "lucide-react";
        ...
        {isOpen && (
          ...
          >
            <div className="bg-asphalt/95 backdrop-blur-3xl rounded-[2rem] shadow-2xl border border-paper/10 overflow-hidden p-2">
              ...
              <Link href="/profile" className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-[#FF8C00]/10 hover:bg-[#FF8C00]/20 transition-colors group text-left">
                <Wallet className="w-4 h-4 text-[#FF8C00]" />
                <span className="text-[11px] font-akina font-bold text-[#FFB45C] group-hover:text-[#FF8C00]">Nạp tiền vào ví</span>
              </Link>
